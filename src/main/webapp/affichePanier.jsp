	...
	<div id="main-sidebar-container">
		...
		<section class="entry">
			<div class="woocommerce">
				<form
					action="<%=response.encodeURL("controlePanier.jsp?requete=recalculerPanier")%>"
					...
					<table class="shop_table cart" cellspacing="0">
						...
						<tbody>
							...
							+ uneLignePanier.getArticle().getRefArticle() + "&amp;requete=supprimerLigne")%>">×</a>
								</td>
				...
				<div class="cart-collaterals">
					...
					<div class="cart_totals ">
						...
						<div class="wc-proceed-to-checkout">
							<a
								href="<%=response.encodeURL("./controleCommande.jsp?requete=effectuerCommande")%>"
								class="checkout-button button alt wc-forward">Effectuer la
								commande</a>
						</div>
						<div class="wc-proceed-to-checkout">
							<a
								href="<%=response.encodeURL("./controlePanier.jsp?requete=viderPanier")%>"
